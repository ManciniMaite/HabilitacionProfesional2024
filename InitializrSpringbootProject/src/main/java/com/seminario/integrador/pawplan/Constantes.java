...
public class Constantes {
    ...
    public static final String URL_PATH_PREGUNTA_SECRETA = "/preguntaSecreta";
    ...
    public static final String URL_PATH_TIPO_ESPECIE = "/tipoEspecie";
    public static final String URL_PATH_ANIMALES = "/animal";
